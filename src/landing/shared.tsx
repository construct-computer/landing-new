...
/* ------------------------------------------------------------------ */
/* Footer - column layout (brand / company / compare)                 */
/* ------------------------------------------------------------------ */
...
const VS_FOOTER_LINKS: readonly FooterLink[] = [
  ...VS_PAGES.map((p) => ({
    label: p.footerLabel,
    href: `/vs/${p.slug}`,
  })),
...
function FooterLinkColumn({
  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="font-ui text-[11px] font-semibold uppercase tracking-[0.12em] text-[#4e4646]">
        {title}
      </p>
        ...
        {links.map((l) =>
          l.betaGate ? (
            <BetaAccessTrigger
              ...
              source="footer"
              variant="link"
              className="font-ui w-fit text-left text-[14px] leading-5 text-[#627c86] transition-colors hover:text-[#01b4c8]"
            >
              {l.label}
            </BetaAccessTrigger>
          ) : (
            <Link
              ...
              className="font-ui w-fit text-[14px] leading-5 text-[#627c86] transition-colors hover:text-[#01b4c8]"
            >
              {l.label}
            </Link>
          ),
  ...
  return (
    <footer className="relative isolate overflow-hidden border-t border-[#e5e7eb] bg-[#fafafa]">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 20% 0%, rgba(1,180,200,0.06) 0%, transparent 60%)",
        }}
      />

      <div className="mx-auto w-full max-w-[1500px] px-6 lg:px-16">
        <div className="grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr] lg:gap-16 lg:py-16">
          {/* Brand */}
          <div className="flex flex-col gap-6 sm:col-span-2 lg:col-span-1">
            <Link
              to="/"
              className="font-display w-fit text-[28px] italic leading-none sm:text-[32px]"
            >
              <span className="text-[#4e4646]">Construct</span>
              <span className="text-[#01b4c8]">Computer</span>
            </Link>
            ...
            <div className="flex items-center gap-3">
              ...
              <SocialIconLink href="https://discord.gg/puArEQHYN9" label="Discord">
                <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden>
                  <path
                    fill="currentColor"
            ...
            <BetaAccessTrigger
              source="footer"
              className="relative mt-2 inline-flex w-fit items-center gap-2 overflow-hidden rounded-full bg-black px-5 py-2.5 text-[13px] font-semibold text-white shadow-[0_4px_4px_0_rgba(0,0,0,0.15)] before:pointer-events-none before:absolute before:inset-0 before:rounded-full before:shadow-[inset_0_-3px_2px_0_rgba(255,255,255,0.15),inset_0_3px_2px_0_rgba(255,255,255,0.18)]"
            >
          ...
          <FooterLinkColumn title="Company" links={COMPANY_LINKS} ariaLabel="Company" />
          <FooterLinkColumn title="Compare" links={VS_FOOTER_LINKS} ariaLabel="Comparisons" />
        </div>
